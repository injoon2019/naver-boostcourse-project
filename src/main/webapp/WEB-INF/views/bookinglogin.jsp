...
<html lang="ko" class="no-js" >
   <head>
      ...
      <base href=".">
      <script>
         var emailExist = ${reservationEmailExist};
         if(!emailExist){
      ...
      <link href="/naverbooking/css/bookinglogin.css" rel="stylesheet">
   </head>
   <body class="biz  ko" >
         ...
         <div class="_view_content" ui-view="content" id="container" >
            <booked-confirm>
               <div class="booking_login">
                  ...
                  <!---->
                  <div >
                     <form name="confirm_form" class="ng-pristine ng-valid" id="form1" action="/naverbooking/bookinglogin" method="post">
                        ...
                        <button type="submit" id="submit-button" form="form1" class="login_btn confirm" > <span translate="CM-MY_BOOKING_CHECK">내 예약 확인</span> </button> <!----> <!----> <!----> <!---->
                     </form>
                  </div>
                  <!----> <!----> 
               </div>
      ...
      <script type="text/javascript" src= "/naverbooking/js/bookinglogin.js"></script>
   </body>
</html>