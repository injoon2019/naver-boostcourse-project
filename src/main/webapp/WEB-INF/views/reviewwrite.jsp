    ...
    <div class="ct">
        <div class="ct_wrap">
            <div class="top_title review_header">
                ...
                <h2><span class="title">${reservationInfoDto.displayInfo.productDescription}</span></h2>
            </div>
            ...
            <div class="review_contents write">
                ...
                <label for="comment-text-area">
                    <textarea id="comment-text-area" name="reviewText" cols="30" rows="10" class="review_textarea" minlength="5" maxlength="400"></textarea>
                </label>
            </div>
            <!-- //리뷰 입력 -->
            ...
            <div class="review_write_footer_wrap">
                <div class="review_write_footer">
                    ...
                    <input type="file" name="reviewImg" class="hidden_input" id="reviewImageFileOpenInput">
                    ...
                    <div class="item_preview_thumbs">
                        <ul class="lst_thumb">
                            <li class="item" style="display: none;">
                                <a href="#" class="cancel_upload anchor">
...
<%--                <input class="bk_btn" type="submit"><span class="btn_txt">리뷰 등록</span></input>--%>
...
<span id="product-id" style="display: none;">${reservationInfoDto.productId}</span>
...
<script type="text/javascript" src= "/naverbooking/js/reviewwrite.js"></script>
</body>
</html>
